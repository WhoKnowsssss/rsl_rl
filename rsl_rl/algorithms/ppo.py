...
class PPO:
    ...
    def __init__(
        ...
        self.estimator_optimizer = optim.Adam(
            self.actor_critic.estimator.parameters(), lr=estimator_learning_rate
        )
    ...
    def update(self):
        ...
        return mean_value_loss, mean_surrogate_loss, mean_recons_loss, mean_vel_loss, mean_kld_loss
